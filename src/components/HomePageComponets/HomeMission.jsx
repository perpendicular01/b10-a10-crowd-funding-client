                ...
                {missions.map((mission, index) => (
                    ...
                    >
                        ...
                        <div className="sm:w-[85%] md:w-[65%] text-center md:text-left space-y-2 lg:pt-10">
                            <h3 className="text-xl lg:text-2xl font-bold">{mission.title}</h3>
                            <p className="w-[95%] lg:w-[90%] text-gray-600 text-sm lg:text-base leading-relaxed">{mission.description}</p>
                        </div>
                    </div>
                ))}
            </div>
